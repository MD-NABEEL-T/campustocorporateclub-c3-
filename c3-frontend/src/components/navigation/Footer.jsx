        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 pb-12 border-b border-white/10">
          ...
          <div className="md:col-span-2 space-y-4">
            <Link to="/" className="inline-flex items-center gap-3">
              ...
              <span className="font-heading font-extrabold text-lg text-white">
                Campus to Corporate <span className="text-[#38BDF8]">Club</span>
              </span>
            </Link>
            ...
            <div className="flex items-center gap-3 pt-2">
              <a
                href="https://github.com/campustocorporateclub"
                target="_blank"
                rel="noreferrer"
                aria-label="GitHub Repository"
                className="w-9 h-9 rounded-full flex items-center justify-center border border-white/10 bg-white/[0.04] text-[#A1A1AA] hover:text-white hover:border-white/20 hover:bg-white/10 transition-colors duration-300"
              >
              ...
              <a
                href="https://www.linkedin.com/company/campus-to-corporate-club-c3/"
                target="_blank"
                rel="noreferrer"
              ...
              <a
                href="mailto:campustocorporateclub@gmail.com"
                aria-label="Email Us"
                className="w-9 h-9 rounded-full flex items-center justify-center border border-white/10 bg-white/[0.04] text-[#A1A1AA] hover:text-white hover:border-white/20 hover:bg-white/10 transition-colors duration-300"
              >
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li className="flex items-center gap-2">
                <span className="w-1.5 h-1.5 rounded-full bg-white/40" /> Corporate Readiness
              </li>
            </ul>
          </div>
        </div>
          ...
          <p className="flex items-center gap-1.5 flex-wrap justify-center">
            ...
            >
              <a
                ...
                rel="noreferrer"
                title="Developer"
                className="relative z-10 font-semibold text-white px-1 hover:text-[#38BDF8] transition-colors duration-300"
              >
                Nabeel
              </a>
            </PointerHighlight>
