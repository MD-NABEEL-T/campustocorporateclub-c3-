...
const defaultColors = ['#ffffff', '#a1a1ff', '#87b2ff'];
...
const vertex = /* glsl */ `
  ...
  void main() {
    ...
    mPos.z += sin(t * random.x + 6.28 * random.y) * mix(0.1, 1.5, random.z);
